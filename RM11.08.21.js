...
function createCustomLayerControl(map) {
  ...
  var modalHTML = `
    <div id="info-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(0, 0, 0, 0.7); z-index: 10000; overflow-y: auto;">
      <div style="max-width: 800px; margin: 40px auto; background: rgba(0, 0, 0, 0.7); border: 2px solid #ffffff; border-radius: 1px; padding: 60px 40px; position: relative; color: #ffffff; font-family: Arial, sans-serif;">
...
// Beim Anzeigen der Layer-Gruppen Reihenfolge beachten (Untersuchungsgebiet ganz unten)
function showLayerGroupHierarchy(map) {
  // Entferne alle Layer-Gruppen zuerst
