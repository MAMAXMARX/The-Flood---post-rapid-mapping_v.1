...
var ortschaften = [
  ...
  { name: "Heimersheim", lat: 50.54499232623629, lon: 7.177233914182003, zoom: 15 },
  { name: "Hönningen", lat: 50.47269107559704, lon: 6.954470296464959, zoom: 15 },
  { name: "Insul", lat: 50.4408717977594, lon: 6.9141474223081625, zoom: 15 },
  ...
  { name: "Liers", lat: 50.45714754730591, lon: 6.942851371228653, zoom: 15 },
  { name: "Mayschoß", lat: 50.52207363618087, lon: 7.018882435222987, zoom: 16 },
  { name: "Müsch", lat: 50.387599104247684, lon: 6.829835767711275, zoom: 15 },
  ...
  { name: "Schuld", lat: 50.44755406075322, lon: 6.8860511604146595, zoom: 15 },
...
function createOrtschaftenControl(map) {
  var OrtschaftenControl = L.Control.extend({
    ...
    onAdd: function(map) {
      ...
      header.innerHTML = '<strong>Ortschaften</strong>';
  ...
  console.log('✅ Ortschaften-Control geladen (rechts)');
}